...
#%%
SS_Data = pd.read_excel("C:/Users/mosta/Desktop/ReactiveController_Commercial_9.0/SSmodels/Temperature_SSModel_15_[20,27].xlsx",
                                      sheet_name = "Zone_3")

###Temperature Model
SS_Data.columns = ["Outdoor temperature", "Zone temperature", "Setpoint", 
                                'Change Setpoint', 'Change Temperature',"Energy"]
