...
:                  "nolimit" if unlimited (used when calling readVarsESO)
 ...
 set program_path=C:\EnergyPlusV9-5-0\
 set program_name=EnergyPlus.exe
 set input_path=C:\Users\mosta\Desktop\ReactiveController_Commercial_9.0\
 set output_path=C:\Users\mosta\Desktop\ReactiveController_Commercial_9.0\
 : If called with full path to an existing file, clear these variables since
 : the first parameter is enough to locate the file 
 IF EXIST "%~1.idf" set input_path= C:\Users\mosta\Desktop\ReactiveController_Commercial_9.0\
 IF EXIST "%~1.idf" set output_path= C:\Users\mosta\Desktop\ReactiveController_Commercial_9.0\
 ...
 set post_proc=C:\EnergyPlusV9-0-1\PostProcess\
 set weather_path=C:\Users\mosta\Desktop\ReactiveController_Commercial_9.0\
 set pausing=N
 set maxcol=250
